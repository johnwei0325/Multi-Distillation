...
def espnet_hubert_large_gs_ll60k(*args, refresh=False, **kwargs):
    url = "https://huggingface.co/espnet/hubert_large_gs_16_librilight60k/resolve/main/home/u8786328store/exp/hubert_iter1_train_ssl_torchaudiohubert_large_960h_pretrain_it2_bins_raw/valid.loss.ave_10best.pth"
    config_url = "https://huggingface.co/espnet/hubert_large_gs_16_librilight60k/blob/main/home/u8786328store/exp/hubert_iter1_train_ssl_torchaudiohubert_large_960h_pretrain_it2_bins_raw/config.yaml"
    ckpt, config = _urls_to_filepaths(url, config_url, refresh=refresh)
    return espnet_hubert_custom(ckpt, config)
